%% Multiple View Geometry 2017, Exercise Sheet 9
...
for lvl = 5:-1:1
    ...
    for i=1:20
        ...
        if (useGD)
            ...
            upd = 0.001 * upd / norm(upd)  
            % choose step size such that the step is always 0.001 long.
        end
...
figure
subplot(121)
imagesc(IRef + reshape(residual,size(IRef)));
axis image
colormap gray;
