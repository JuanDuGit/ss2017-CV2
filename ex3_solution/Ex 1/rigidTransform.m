...
function W = rigidTransform(V,alpha,beta,gamma,tx,ty,tz)
...
% Translation matrix (translates the model by (tx,ty,tz)):
Trans = [eye(3,3), [tx ty tz]'; zeros(1,3), 1];

% Overall transformation matrix:
G = Trans * Tback * Rz * Ry * Rx * T;
